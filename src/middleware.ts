...
export async function middleware(request: NextRequest) {
  ...
  // Team membership check happens in the layout via getAuthUser()
  // which redirects inactive users to /pending.
  // Removing it from middleware to stay within Vercel Hobby 10s limit.
